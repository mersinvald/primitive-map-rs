...
fn indexmap_fun_insert<K: std::hash::Hash + Eq + Copy + Step + Debug + 'static>(
    name: &'static str,
    map: IndexMap<K, K>,
) -> Fun<(K, K)> {
    Fun::new(name, move |b, &(low, high)| {
...
fn indexmap_fun_get<K: std::hash::Hash + Eq + Copy + Step + Debug + 'static>(
    name: &'static str,
    map: IndexMap<K, K>,
) -> Fun<(K, K)> {
    Fun::new(name, move |b, &(low, high)| {
...
fn std_hashmap_fun_insert<K: std::hash::Hash + Eq + Copy + Step + Debug + 'static>(
    name: &'static str,
    map: HashMap<K, K>,
) -> Fun<(K, K)> {
    Fun::new(name, move |b, &(low, high)| {
...
fn std_hashmap_fun_get<K: std::hash::Hash + Eq + Copy + Step + Debug + 'static>(
    name: &'static str,
    map: HashMap<K, K>,
) -> Fun<(K, K)> {
    Fun::new(name, move |b, &(low, high)| {
